...
$sql="select * from patientdata where enrollmentno='$enrollmentno'";
$result=mysqli_query($cn,$sql);
$n=mysqli_num_rows($result);
if($n==1)
{
	...
	?>
		...
		<form id="form1" name="form1" method="post" action="managenodalpatient1.php">
<table style="border-collapse: separate;
	...
	elseif(isset($_POST["b2"]))
	{
        ...
        <p>
            ...
            <a href="shownodalpatient.php" style="color:#f00; font-size:24px;">Back</a>
        </p>
        <form method="post" action="managenodalpatient1.php">
...
else
{
    ...
    <h4><a href="shownodalpatient.php">Continue...</a></h4>
	<?php
}
?>
