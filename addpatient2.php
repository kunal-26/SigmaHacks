...
?>  
     ...
     <!-- Area Chart Example-->
        ...
        <div class="card-header">
          <i class="fa fa-area-chart"></i> ADD Patient</div>
        <div class="card-body">
...
if($n>0)
{
	...
	?>
            	...
            	<form id="form1" name="form1" method="post" action="addpatient3.php">
  ...
  <td>
    <label for="t4"></label>
    <input readonly value="<?php echo $b; ?>" type="text" name="t4" required/></td>
  </td>
  </tr>
  		<?php
