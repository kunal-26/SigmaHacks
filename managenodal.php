...
?>  
      ...
      <!-- Area Chart Example-->
        ...
        <div class="card-header">
          <i class="fa fa-area-chart"></i> Show Patient</div>
        <div class="card-body">
...
$sql="select * from nodaldata where enrollmentno='$enrollmentno'";
$result=mysqli_query($cn,$sql);
$n=mysqli_num_rows($result);
if($n==1)
{
	...
	?>
		...
		<form id="form1" name="form1" method="post" action="managenodal1.php">
<table style="border-collapse: separate;
    border-spacing: 0 1em;">
         <tr>
          ...
          Adhaar No. : </th><td><input value="<?php echo $c; ?>" type="text" name="t3" id="t3" 
          required/></td></tr>
          <tr>
           <th style="color:#000; font-family:'Comic Sans MS', cursive">
		  Quarantine Centre Id : </th><td><input value="<?php echo $e; ?>" type="text" name="t4"
           id="t4" 
          required/></td></tr>
		  </td></tr>
          <tr>
          ...
          Email : </th><td><input value="<?php echo $d; ?>" type="text" name="t5" id="t5" 
          pattern="^[-+.\w]{1,64}@[-.\w]{1,64}\.[-.\w]{2,6}$" required /> 
		</td></tr>
        <tr>
           <th style="color:#000; font-family:'Comic Sans MS', cursive"> 
		  
       City :  </th><td><input value="<?php echo $f; ?>" type="text" name="t6" id="t6" 
           required /> 
	</td></tr> 
	...
	elseif(isset($_POST["b2"]))
	{
        ...
        <p>
            ...
            Name : <?php echo $b; ?><br />
            Ahaar No. :  <?php echo $c; ?><br />
            Quarantine Centre Id : <?php echo $e; ?><br/>
            E-mail :  <?php echo $d; ?><br />

            <a href="shownodal.php" style="color:#f00; font-size:24px;">Back</a>
        </p>
        <form method="post" action="managenodal1.php">
...
else
{
    ...
    <h4><a href="shownodal.php">Continue...</a></h4>
	<?php
}
?>
