...
<button class="navbar-toggler navbar-toggler-right" type="button" data-toggle="collapse" data-target="#navbarResponsive" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation">
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      ...
      </ul>      <ul class="navbar-nav sidenav-toggler">
        <li class="nav-item">
          <a class="nav-link text-center" id="sidenavToggler">
            <i class="fa fa-fw fa-angle-left"></i>
          </a>
...
?>  
      ...
      <!-- Area Chart Example-->
        ...
        <div class="card-header">
          <i class="fa fa-area-chart"></i> ADD Nodal Officer</div>
        <div class="card-body">
          <canvas id="myAreaChart" width="100%" height="30"></canvas>
          <div style="padding:40px 20px"> 
         		<form id="form1" name="form1" method="post" action="addnodal1.php">
  <table style="border-collapse: separate;
    border-spacing: 0 1em;">

  <tr><th style="color:#000; font-family:'Comic Sans MS', cursive;">Enrollment No</th>
  <td>
    <label for="t9"></label>
    <input type="text" name="t9" pattern="[6-9]{1}[0-9]{9}" required/>
  </td></tr>
  <tr><th style="color:#000; font-family:'Comic Sans MS', cursive;">
  E-mail</th>
  <td> 
    <label for="t1"></label>
    <input type="email" name="t1" pattern="^[-+.\w]{1,64}@[-.\w]{1,64}\.[-.\w]{2,6}$" required/>
  </td></tr>
  <tr><th style="color:#000; font-family:'Comic Sans MS', cursive;">Name</th>
  <td>
   
    <label for="t2"></label>
    <input type="text" name="t2"  required/>
  </td></tr>
  <tr><th style="color:#000; font-family:'Comic Sans MS', cursive;">Adhaar Card No.</th>
  <td> 
    <label for="t3"></label>
  ...
  <tr>
  <th style="color:#000; font-family:'Comic Sans MS', cursive;">Quarantine Centre</th>
  <td>
    <label for="t4"></label>
  ...
  <tr><th style="color:#000; font-family:'Comic Sans MS', cursive;">password</th>
  <td>
  <label for="t7"></label>
  ...
  <tr><th style="color:#000; font-family:'Comic Sans MS', cursive;">City</th>
  <td>
  <label for="t6"></label>
