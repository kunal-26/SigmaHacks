...
?>  
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-area-chart"></i>Routine Check Up</div>
        <div class="card-body">
          <canvas id="myAreaChart" width="100%" height="30"></canvas>
          <div style="padding:40px 20px"> 
       <h2>Give Your Routine Check Up	</h2>
       <?php 
...
$sql="select * from routine where enrollmentno='$e1'";
//Fetch data
$result=mysqli_query($cn,$sql);
...
if($n>0)
{
	...
	?>
          			...
          			<form id="form1" name="form1" method="post" action="routine1.php">
...
<tr>
  <th style="color:#000; font-family:'MS Serif', 'New York', serif;">How are you feeling today?
  </th>

  <td style="color:#000;">
   <input type="radio" name="t2" id="t2" value="Fresh"  />Fresh<br/>
<input type="radio" name="t2" id="t2"  value="Nauseated"/>Nauseated
<br/>
<input type="radio" name="t2" id="t2" value="Anxious" />Anxious
<br/>
<input type="radio" name="t2" id="t2"  value="Happy"/>Happy
...
<br/>
    ...
    <tr>
  <th style="color:#000; font-family:'MS Serif', 'New York', serif;">
  Facing any breathing uneasiness?</th>

  <td style="color:#000;">
   <input type="radio" name="t3" id="t3" value="Not at all"  />Not at all<br/>
<input type="radio" name="t3" id="t3"  value="A Bit"/>A Bit
<br/>
<input type="radio" name="t3" id="t3" value="Yes" />Yes
<br/>
      ...
      <tr>
  <th style="color:#000; font-family:'MS Serif', 'New York', serif;">Feedback about the food:</th>

  <td style="color:#000;">
   <input type="radio" name="t4" id="t4" value="Healthy and Ample"  />Healthy and Ample<br/>

<input type="radio" name="t4" id="t4"  value="Will be registering query"/>Will be registering query</span>
      ...
      <tr>
  <th style="color:#000; font-family:'MS Serif', 'New York', serif;">
  Want to recieve daily alert for this routine checkup?</th>

  <td style="color:#000;">
   <input type="radio" name="t5" id="t5" value="Yes"  />Yes<br/>
<input type="radio" name="t5" id="t5"  value="No"/>No<br/>
...
<tr>
  <th style="color:#000; font-family:'MS Serif', 'New York', serif;">
  Sanitization routines followed? </th>

  <td style="color:#000;">
   <input type="radio" name="t6" id="t6" value="Yes"  />Yes<br/>
<input type="radio" name="t6" id="t6"  value="No"/>No
<br/>

<input type="radio" name="t6" id="t6"  value="Rarely"/>Rarely
