...
if(isset($_POST["b1"]))
 {
	...
	$sql="update nodaldata set name='$b',adhaar='$c',email='$d',quarantine='$e',city=$f 
	...
	if($n==1)
	{
      ...
      <div style="border-radius:200px; height:200px; width:200px; background: #F8FAF5; margin:0 auto;">
        ...
        <h3><a href="shownodal.php">Continue...</a></h3>
      </div>
...
$cn=mysqli_connect("localhost","id14460988_google","Kunal@26082608","id14460988_sigma");
	...
	$q1="delete from nodaldata where enrollmentno='$a'";
