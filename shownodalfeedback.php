...
$sql="select * from feedback where quarantine=$b";
...
if($n>0)
{
	...
	while($rw=mysqli_fetch_array($result))
	{
        ...
        <p>
            ...
            Food : <?php echo $c; ?> pointers<br/>
            Medicine : <?php echo $d; ?> pointers<br/>
            Doctor : <?php echo $e; ?> pointers<br/>
            Environment : <?php echo $f; ?> pointers<br/>
            Overall : <?php echo $g;?> pointers<br/>
            </p>
