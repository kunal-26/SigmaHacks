...
$cn=mysqli_connect("localhost","id14460988_google","Kunal@26082608","id14460988_sigma");
	...
	$q1="insert into nodaldata (enrollmentno,name,email,adhaar,quarantine,city,password)
	 values
	($enrollmentno,'$name','$email','$adhaar','$quarantine','city','$password')";
	...
	if($n1==1 && $n2==1)
 	{
      ...
      <div style="border-radius:200px; height:200px; width:200px; background: #F8FAF5; margin:0 auto;">
        ...
        <h1>Welcome new Officer</h1>
        <h3>Login created</h3>
        <h3><a href="addnodal.php">Continue</a></h3> 
      </div>
	<?php
...
?>
 ...
 ?>
   <h3><a href="addnodal.php">Form Fill</a></h3>
