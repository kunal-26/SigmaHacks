...
?>  
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-area-chart"></i> Query</div>
        <div class="card-body">
  ...
  <th style="color:#000; font-family:'MS Serif', 'New York', serif;">Qaurantine Centre</th>
    <td><label for="t1"></label>
    <input readonly value="<?php echo $b; ?>" type="text" name="t2" required/></td>
    </tr>
		<?php
...
?>
  ...
  <td> 
    <label for="t4"></label>
    <input placeholder="Enter a valid email" type="email" name="t4" pattern="^[-+.\w]{1,64}@[-.\w]{1,64}\.[-.\w]{2,6}$" required/>
  </td></tr>
  
  
    <tr><th style="color:#000; font-family:'Comic Sans MS', cursive;">query</th><td><textarea rows="4" cols="50" name="t5">
</textarea></td></tr>        
  <tr>
  <th></th>
  <td style="color:#000;">
