...
?>  
      ...
      <!-- Area Chart Example-->
        ...
        <div class="card-header">
          <i class="fa fa-area-chart"></i> Show Feedback</div>
        <div class="card-body">
...
$sql="select * from routine where quarantine=$b";
...
if($n>0)
{
	...
	while($rw=mysqli_fetch_array($result))
	{
        ...
        <p>
            ...
            Quarantine Center Id : <?php echo $b; ?> <br/>
            How are you feeling today? : <?php echo $c; ?><br/>
            Facing any breathing uneasiness? : <?php echo $d; ?><br/>
            Feedback about the food : <?php echo $e; ?><br/>
            Want to recieve daily alert for this routine checkup? : <?php echo $f; ?><br/>
            Sanitization routines followed? : <?php echo $g;?><br/>
            </p>
